                ...
                <div class="card">
                    ...
                    <div class="card-body pt-2 pl-3 pb-3  border-top-0">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <p class="mt-3 mb-0"><b>{{ $project_document->document_type }}</b></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-10">
                                <a href="#"><p class="mt-0 mb-0"><b>{{ $project_document->project_title }}</b></p></a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#showall').DataTable( {
                "ajax": "/getdocuments?f=&t=documentonly&d="+document_type_id+"&p="+plan_id+"&c="+contractor_id,
                "columns": [
                    {
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row){
                            ...
                            if(data == 'ended'){
                                html = '<span class="badge badge-warning text-center">'+data+'</span>';
                            }
                            return html;
                        }
                    },
