              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="white-space: nowrap">
                    ...
                    @if( $project_plan->mode == "Bidding")
                    <a class="btn btn-sm btn-success" target='_blank' href="/project_bidders/{{$project_plan->plan_id}}" >Bidders:{{$project_plan->bidder_count}}</a>
                    @else
                    <a class="btn btn-sm btn-success" target='_blank' href="/project_bidders/{{$project_plan->plan_id}}" >Price Quotations:{{$project_plan->bidder_count}}</a>
                    @endif
                    @else
                    @if( $project_plan->mode == "Bidding")
                    <a class="btn btn-sm bg-teal text-white" target='_blank' href="/project_bidders/{{$project_plan->plan_id}}" >Bidders:{{$project_plan->bidder_count}}</a>
                    @else
                    <a class="btn btn-sm bg-teal text-white" target='_blank' href="/project_bidders/{{$project_plan->plan_id}}" >Price Qoutations:{{$project_plan->bidder_count}}</a>
                    @endif
                    @endif
