        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title" id="form_modal_title">Set Procurement Date</h3>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body pt-0">
              <form class="col-sm-12" method="POST" id="submit_preprocurement" action="submit_preprocurement">
                @csrf
                <div class="row">
                  <div class="form-group col-xs-6 col-sm-6 col-lg-6 mx-auto">
                    <h5 for="preprocurement_date">Plan Id/s</h5>
                  ...
                  <div class="form-group col-xs-16 col-sm-6 col-md-6 mb-2  mb-0">
                    <h5 for="preprocurement_date">Pre-procurement Date</h5>
                    <input type="text" id="preprocurement_date" name="preprocurement_date" class="form-control form-control-sm datepicker" value="{{old('preprocurement_date')}}" >
            ...
            <table class="table table-bordered" id="app_table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="white-space: nowrap"><button class="btn btn-sm btn btn-sm btn-primary set_date_btn" >Set Date</button>@if($project_plan->current_cluster) <span class="badge bg-yellow">Clustered</span>@endif</td>
                  <td>{{ $project_plan->plan_id }}</td>
                  <td>{{ date("M d,Y", strtotime($project_plan->advertisement_start))}} - {{ date("M d,Y", strtotime($project_plan->advertisement_end))}}</td>
                  <td>{{ $project_plan->current_cluster }}</td>
                  <td>{{ $project_plan->app_group_no }}</td>
