    ...
    <div id="app">
      <div class="card shadow mt-4 mb-5" >
        <div class="card shadow border-0"  style="background:#F7F5F5">
          ...
          <div class="card-body ">
            <form class="row" method="POST" id="meeting_form" action="{{route('submit_adjust_sapp')}}" enctype="multipart/form-data">
              @csrf
              <!-- ID -->
              ...
              @if($additional_sapp==true)
                ...
                <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0 d-none">
                  ...
                  <input type="text" id="additional_sapp" name="additional_sapp" class="form-control" value="{{old('id')}}" >
                  <label class="error-msg text-red" >@error('additional_sapp'){{$message}}@enderror
                  </label>
                </div>
              @endif
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0">
                ...
                <input type="text" id="date_added" name="date_added" class="form-control datepicker" value="{{old('date_added')}}" >
                <label class="error-msg text-red" >@error('date_added'){{$message}}@enderror
                </label>
              </div>

              <!-- project year -->
              <div class="form-group col-xs-12 col-sm-3 col-lg-3 mb-0">
              ...
              <div class="form-group col-xs-12 col-sm-3 col-lg-3 mb-0">
                ...
                <input class="form-control yearpicker" id="year_funded" name="year_funded" value="{{old('year_funded')}}" >
                <label class="error-msg text-red" >@error('year_funded'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-0">
                ...
                <label class="error-msg text-red" >@error('app_number'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-8 col-lg-8 mb-0">
                ...
                <input type="" id="project_title" name="project_title" class="form-control" value="{{old('project_title')}}" >
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0">
                ...
                <label class="error-msg text-red" >@error('municipality'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0">
                ...
                <label class="error-msg text-red" >@error('barangay'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-0">
                ...
                <input type="" id="project_number" name="project_number" class="form-control" value="{{old('project_number')}}" >
              ...
              <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-0">
                ...
                <label class="error-msg text-red" >@error('account_code'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-0">
                ...
                <label class="error-msg text-red" >@error('source_of_fund'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0">
                ...
                <input type="" id="approved_budget_cost" name="approved_budget_cost" class="form-control money2" value="{{old('approved_budget_cost')}}" >
                <label class="error-msg text-red" >@error('approved_budget_cost'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0 d-none">
                ...
                <label class="error-msg text-red" >@error('sector_type'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0 d-none">
                ...
                <label class="error-msg text-red" >@error('sector'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0">
                ...
                <label class="error-msg text-red" >@error('type_of_project'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0">
                ...
                <input type="text" id="ABC_post_date" name="ABC_post_date" class="form-control monthpicker" value="{{old('ABC_post_date')}}" >

                <label class="error-msg text-red" >@error('ABC_post_date'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0">
                ...
                <input type="" id="opening_of_bid" name="opening_of_bid" class="form-control monthpicker" value="{{old('opening_of_bid')}}" >
                <label class="error-msg text-red" >@error('opening_of_bid'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0">
                ...
                <input type="" id="notice_of_award" name="notice_of_award" class="form-control monthpicker" value="{{old('notice_of_award')}}" >
                <label class="error-msg text-red" >@error('notice_of_award'){{$message}}@enderror
                </label>
              </div>
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0">
                ...
                <input type="" id="contract_signing" name="contract_signing" class="form-control monthpicker" value="{{old('contract_signing')}}" >
                <label class="error-msg text-red" >@error('contract_signing'){{$message}}@enderror
                </label>
              </div>
...
@push('custom-scripts')
  ...
  $(".yearpicker").datepicker('setDate','{{$year}}');
  ...
  if(oldInputs>0){
    ...
    $("#date_added").datepicker('setDate',"{{old('date_added')}}");
    $("#project_year").datepicker('setDate',"{{old('project_year')}}");
    $("#year_funded").datepicker('setDate',"{{old('year_funded')}}");
    getSector();
    ...
    if(data.length>0){
      if("{{$additional_sapp}}"!="1"){
        ...
        $("#date_added").datepicker('setDate',moment(moment(passed_data.date_added).format('Y-MM-DD')).format("MM/DD/YY"));
        $("#ABC_post_date").datepicker('setDate',moment(moment(passed_data.abc_post_date).format('MMM-Y')).format('MM-Y'));
        $("#opening_of_bid").datepicker('setDate',moment(moment(passed_data.sub_open_date).format('MMM-Y')).format('MM-Y'));
        $("#notice_of_award").datepicker('setDate',moment(moment(passed_data.award_notice_date).format('MMM-Y')).format('MM-Y'));
        $("#contract_signing").datepicker('setDate',moment(moment(passed_data.contract_signing_date).format('MMM-Y')).format('MM-Y'));
      }
      if("{{$additional_sapp}}"=="1"){
        $("#app_form").prop('action','/submit_adjust_app');
      }
      else{
      ...
      $("#project_year").datepicker('setDate',moment('01-01-'+passed_data.project_year).format('Y'));
      // $("#year_funded").datepicker('setDate',moment('01-01-'+passed_data.year_funded).format('Y'));
