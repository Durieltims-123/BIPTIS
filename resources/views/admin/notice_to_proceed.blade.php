        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title" id="form_modal_title">Set Notice To Proceed Date</h3>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body pt-0">
              <form class="col-sm-12" method="POST" id="submit_award_notice" action="/submit_notice_to_proceed">
                @csrf
                <div class="row">
                  <div class="form-group col-xs-6 col-sm-6 col-lg-6 mx-auto">
                    <h5 for="notice_to_proceed_date">Plan Id/s</h5>
                  ...
                  <div class="form-group col-xs-16 col-sm-6 col-md-6 mb-2  mb-0">
                    <h5 for="notice_to_proceed_date"> Notice to Proceed Date</h5>
                    <input type="text" id="notice_to_proceed_date" name="notice_to_proceed_date" class="form-control form-control-sm datepicker" value="{{old('notice_to_proceed_date')}}" >
