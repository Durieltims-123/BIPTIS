        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title" id="form_modal_title">Add Performance Bond Date</h3>
              ...
              <form class="col-sm-12" method="POST" id="bidders_form" action="{{route('submit_additional_performance_bond')}}">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-12 col-sm-12 col-lg-12 mb-0">
                    <label for="perfomance_bond_date_issuance">Performance Bond Date of Issuance<span class="text-red">*</span></label>
                    <input type="text" id="perfomance_bond_date_issuance" name="perfomance_bond_date_issuance" class="form-control form-control-sm bg-white datepicker"  value="{{old('perfomance_bond_date_issuance')}}" >
                    <label class="error-msg text-red" >@error('perfomance_bond_date_issuance'){{$message}}@enderror
                    </label>
                  </div>
...
var table=  $('#app_table').DataTable({
  ...
  columns: [
    ...
    render: function ( data, type, row ) {
      console.log(data);
      if(data!=null){
        return '@if(in_array("update",$user_privilege))<div style="white-space: nowrap"><button class="btn btn-sm btn btn-sm btn-primary add_btn btn-smmr-0" data-toggle="tooltip" data-placement="top" title="Add"> <i class="ni ni-fat-add"></i>@endif</div>';
      }
...
$('#app_table tbody').on('click', '.add_btn', function (e) {
  $('.error-msg').html("");
  $("#form_modal_title").html('Add Performance Bond Date');
  ...
  $("#perfomance_bond_date_issuance").val('');
