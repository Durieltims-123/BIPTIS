    ...
    <div class="card shadow">
      <div class="card shadow border-0">
        <div class="card-header">
          <h2 id="title">Generate Awarded Projects</h2>
        </div>
        <div class="card-body">
          <form class="col-sm-8 mx-auto" method="POST" id="" action="/submit_generate_awarded">
            ...
            <div class="row d-flex">
              ...
              <div class="form-group col-xs-2 col-sm-2 col-lg-2 mt-4 d-flex">
                ...
                <a class="btn btn-info text-center" target="_blank" href="/download_awarded/{{date('Y-m-d',strtotime(old('date_start')))}}/{{date('Y-m-d',strtotime(old('date_end')))}}">Download</a>
                @endif
              </div>
