        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title" id="form_modal_title">Set Pre-bid Date</h3>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body pt-0">
              <form class="col-sm-12" method="POST" id="submit_prebid" action="/submit_prebid">
                @csrf
                <div class="row">
                  <div class="form-group col-xs-6 col-sm-6 col-lg-6 mx-auto">
                    <h5 for="pre_bid_date">Plan Id/s</h5>
                  ...
                  <div class="form-group col-xs-16 col-sm-6 col-md-6 mb-2  mb-0">
                    <h5 for="pre_bid_date">Pre-bid Date</h5>
                    <input type="text" id="pre_bid_date" name="pre_bid_date" class="form-control form-control-sm datepicker" value="{{old('pre_bid_date')}}" >
            ...
            <table class="table table-bordered" id="app_table">
              <thead class="">
                <tr class="bg-primary text-white" >
                  ...
                  <th class="text-center">Prebid Date</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="white-space: nowrap"><button class="btn btn-sm btn btn-sm btn-primary set_date_btn" >Set Date </button>
                  ...
                  <td>{{ date("M d,Y", strtotime($project_plan->pre_bid_start))}} - {{ date("M d,Y", strtotime($project_plan->pre_bid_end))}}</td>
...
$('#app_table tbody').on('click', '.rebid_btn', function (e) {
  ...
  Swal.fire({
    ...
    if(result.value==true){
      ...
      $("#rebid_project_title").val(data[4]);
      $("#rebid_modal").modal('show');
    }
  });
...
$('#app_table tbody').on('click', '.review_btn', function (e) {
  ...
  Swal.fire({
    ...
    if(result.value==true){
      ...
      $("#review_project_title").val(data[4]);
      $("#review_modal").modal('show');
    }
  });
});
