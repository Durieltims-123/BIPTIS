...
var table=  $('#app_table').DataTable({
  ...
  columns: [
    ...
    render: function ( data, type, row ) {
      let link='<div style="white-space: nowrap">@if(in_array("update",$user_privilege))<a class="btn btn-sm btn btn-sm btn-success text-white" target="_blank" href="/post_qual_project_bidders/'+row.plan_id+'"><i class="ni ni-circle-08"></i></a>@endif';
