  ...
  <div id="row ">
    ...
    <div class=" col-sm-8 shadow mx-auto ">
      <div class="card border-0">
        ...
        <div class="card-body">
          <form method="post" action="{{route('submit_unreceive_bidders_documents')}}">
            @csrf
...
if("{{session('message')}}"){
  if("{{session('message')}}"=="password_error"){
    ...
    swal.fire({
      title: `Unreceive Success`,
      text: 'Successfully Unreceived Bidder Documents',
      buttonsStyling: false,
    ...
    swal.fire({
      title: `Opening Error`,
      text: 'Sorry you cannot unreceive documents after opening!',
      buttonsStyling: false,
      confirmButtonClass: 'btn btn-sm btn-danger',
      icon: 'danger'
    });
