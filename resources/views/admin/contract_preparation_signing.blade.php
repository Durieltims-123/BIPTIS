        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title" id="form_modal_title">Set Contract Preparation and Signing Date</h3>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body pt-0">
              <form class="col-sm-12" method="POST" id="submit_award_notice" action="/submit_contract_preparation_and_signing">
                @csrf
                <div class="row">
                  <div class="form-group col-xs-6 col-sm-6 col-lg-6 mx-auto">
                    <h5 for="contract_preparation_and_signing_date">Plan Id/s</h5>
                  ...
                  <div class="form-group col-xs-16 col-sm-6 col-md-6 mb-2  mb-0">
                    <h5 for="contract_preparation_and_signing_date">Contract Preparation/Signing Date</h5>
                    <input type="text" id="contract_preparation_and_signing_date" name="contract_preparation_and_signing_date" class="form-control form-control-sm datepicker" value="{{old('contract_preparation_and_signing_date')}}" >
...
if("{{session('message')}}"){
  if("{{session('message')}}"=="range_error"){
    ...
    $("#plan_id").val('');
    $("#contract_preparation_and_signing_date").val('');
