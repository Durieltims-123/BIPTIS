    ...
    <div id="app">
      <div class="card shadow mt-4 mb-5">
        <div class="card shadow border-0">
          ...
          <div class="card-body">
            <form class="row" id="app_form" name="app_form" type="POST" action="/submit_plan">
              ...
              <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0">
                ...
                <input type="" id="approved_budget_cost" name="approved_budget_cost" class="form-control" value="{{old('approved_budget_cost')}}" >
