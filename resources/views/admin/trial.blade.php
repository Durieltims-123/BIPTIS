                ...
                <div class="row">
                  ...
                  <div class="form-group col-xs-6 col-sm-6 col-lg-6 mx-auto">
                    <label for="date_pow_added">Date POW Added <span class="text-red">*</span</label>
                      ...
                      <label class="error-msg text-red" >@error('date_pow_added'){{$message}}@enderror</label>
                    </div>
                    ...
                    <div class="form-group col-xs-6 col-sm-6 col-lg-6">
                      ...
                      <label class="error-msg text-red" >@error('duration'){{$message}}@enderror</label>
                    </div>
            ...
            <div class="col-sm-12 d-none" id="filter">
              <form class="row" id="app_filter" method="post" action="{{route('filter_app')}}">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-lg-6 mb-0">
                  ...
                  <label class="error-msg text-red" >@error('pow'){{$message}}@enderror</label>
                </div>
  ...
  var table=  $('#app_table').DataTable({
    ...
    columns: [
      ...
      render: function ( data, type, row ) {
        if(data!=null){
          return "<div style='white-space: nowrap'><button class='btn btn-sm shadow-0 border-0 text-white btn-success edit_pow' value='"+row.plan_id+"' ><i class='ni ni-ruler-pencil'></i></button><button value='"+row.plan_id+"' class='btn btn-sm  shadow-0 border-0 btn-danger delete_btn'><i class='ni ni-basket text-white'></i></button></div>";
        }
        else{
          return "<div style='white-space: nowrap'><button  class='btn btn-sm shadow-0 border-0 btn-primary text-white add_pow'  value='"+row.plan_id+"'>Add Pow</button></div>";
        }
      }},
      {"data":"plan_id"},
      {"data":"app_group_no"},
