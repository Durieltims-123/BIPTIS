    ...
    <div class="col-lg-5 col-md-7">
      <div class="card bg-secondary shadow border-0">
        <div class="card-header bg-transparent pb-5">
          <div class="text-muted text-center"><small>{{ __('Sign in') }}</small></div>
        </div>
...
<script>
// swal.fire({
//   title: "BIPTIS Version 2.0",
//   text: 'Please notify developer for system bugs and design improvement. Your suggestions and concerns are highly favorable for the improvement of this product.  Thank you for using BIPTIS.',
