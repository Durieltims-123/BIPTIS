        ...
        <div class="card-body">
          <div class="row">
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Project Number</strong></label>
              <input readonly class="form-control bg-white text-black" value="{{$project_details->project_no}}">
            </div>
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Location</strong></label>
            ...
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Mode of Procurement</strong></label>
              <input readonly class="form-control bg-white text-black" value="{{ $project_details->mode }}">
            </div>
          </div>
          <div class="row">
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Contractor</strong></label>
              <input readonly class="form-control bg-white text-black" value="{{$project_details->business_name}}">
            </div>
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Bid as Read @if($project_details->plan_cluster_id)<span class="badge bg-yellow">Cluster {{$project_details->plan_cluster_id}}</span>@endif</strong></label>
            ...
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Bid as Evaluated @if($project_details->plan_cluster_id)<span class="badge bg-yellow">Cluster {{$project_details->plan_cluster_id}}</span>@endif</strong></label>
            ...
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Bid as Calculated @if($project_details->plan_cluster_id)<span class="badge bg-yellow">Cluster {{$project_details->plan_cluster_id}}</span>@endif</strong></label>
            ...
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Planned Posting</strong></label>
              <input readonly class="form-control bg-white text-black" value="{{$project_details->abc_post_date}}">
            </div>
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Planned Opening</strong></label>
              <input readonly class="form-control bg-white text-black" value="{{$project_details->sub_open_date}}">
            </div>
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Planned Notice of Award</strong></label>
              <input readonly class="form-control bg-white text-black" value="{{$project_details->award_notice_date}}">
            </div>
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Planned Contract Signing</strong></label>
              <input readonly class="form-control bg-white text-black" value="{{$project_details->contract_signing_date}}">
            </div>
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Date Pow Added</strong></label>
              <input readonly class="form-control bg-white text-black" value="{{$project_details->date_pow_added}}">
            </div>
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Duration</strong></label>
              <input readonly class="form-control bg-white text-black" value="{{$project_details->duration}}">
            </div>
          </div>
          <div class="row">
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>ABC</strong></label>
              <input readonly class="form-control bg-white text-black" value="{{ number_format($project_details->abc,2,'.',',') }}">
            </div>
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Project Cost</strong></label>
              <input readonly class="form-control bg-white text-black" value="@if($project_details->project_cost){{ number_format($project_details->project_cost,2,'.',',') }}@else {{ number_format($project_details->abc,2,'.',',') }} @endif">
            </div>
            <div class="form-group col-xs-12 col-sm-4 col-lg-4 mb-2 ">
              <label class="text-black"><strong clas>Source of Fund</strong></label>
          ...
          <div class="table-responsive">
            <table class="table table-bordered" id="timelines_table">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$row_number}}</td>
                  <td>@if($project_timeline->advertisement_start){{ date("M d,Y", strtotime($project_timeline->advertisement_start))}} - {{ date("M d,Y", strtotime($project_timeline->advertisement_end))}} @endif</td>
                  <td>@if($project_timeline->pre_bid_start) {{ date("M d,Y", strtotime($project_timeline->pre_bid_start))}} - {{ date("M d,Y", strtotime($project_timeline->pre_bid_end))}} @endif</td>
                  <td>@if($project_timeline->bid_submission_start){{ date("M d,Y", strtotime($project_timeline->bid_submission_start))}} - {{ date("M d,Y", strtotime($project_timeline->bid_submission_end))}} @endif</td>
                  <td>@if($project_timeline->bid_evaluation_start){{ date("M d,Y", strtotime($project_timeline->bid_evaluation_start))}} - {{ date("M d,Y", strtotime($project_timeline->bid_evaluation_end))}} @endif</td>
                  <td>@if($project_timeline->post_qualification_start){{ date("M d,Y", strtotime($project_timeline->post_qualification_start))}} - {{ date("M d,Y", strtotime($project_timeline->post_qualification_end))}} @endif</td>
                  <td>@if($project_timeline->award_notice_start){{ date("M d,Y", strtotime($project_timeline->award_notice_start))}} - {{ date("M d,Y", strtotime($project_timeline->award_notice_end))}} @endif</td>
                  <td>@if($project_timeline->contract_signing_start){{ date("M d,Y", strtotime($project_timeline->contract_signing_start))}} - {{ date("M d,Y", strtotime($project_timeline->contract_signing_end))}} @endif</td>
                  <td>@if($project_timeline->authority_approval_start) {{ date("M d,Y", strtotime($project_timeline->authority_approval_start))}} - {{ date("M d,Y", strtotime($project_timeline->authority_approval_end))}} @endif</td>
                  <td>@if($project_timeline->proceed_notice_start){{ date("M d,Y", strtotime($project_timeline->proceed_notice_start))}} - {{ date("M d,Y", strtotime($project_timeline->proceed_notice_end))}} @endif</td>
          ...
          <div class="table-responsive">
            <table class="table table-bordered" id="procacts_table">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$row_number}}</td>
                  <td>@if($procact->pre_proc){{ date("M d,Y", strtotime($procact->pre_proc))}} @endif</td>
                  <td>@if($procact->advertisement) {{ date("M d,Y", strtotime($procact->advertisement))}} @endif</td>
                  <td>@if($procact->pre_bid){{ date("M d,Y", strtotime($procact->pre_bid))}} @endif</td>
                  <td>@if($procact->open_bid){{ date("M d,Y", strtotime($procact->open_bid))}} @endif</td>
                  <td>@if($procact->open_time){{ date("h:i a", strtotime($procact->open_time))}} @endif</td>
                  <td>@if($procact->bid_evaluation){{ date("M d,Y", strtotime($procact->bid_evaluation))}} @endif</td>
                  <td>@if($procact->post_qual){{ date("M d,Y", strtotime($procact->post_qual))}} @endif</td>
                  <td>@if($procact->award_notice) {{ date("M d,Y", strtotime($procact->award_notice))}} @endif</td>
                  <td>@if($procact->contract_signing){{ date("M d,Y", strtotime($procact->contract_signing))}} @endif</td>
                  <td>@if($procact->authority_approval){{ date("M d,Y", strtotime($procact->authority_approval))}} @endif</td>
                  <td>@if($procact->proceed_notice){{ date("M d,Y", strtotime($procact->proceed_notice))}} @endif</td>
            ...
            <table class="table table-bordered" id="bidders_table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>@if($bidder->bid_status!="" || $bidder->bid_status!=null){{$bidder->bid_status}}@else DNS @endif</td>
