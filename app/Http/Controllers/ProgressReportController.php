...
class ProgressReportController extends Controller
{
    ...
    function getTableData(Request $request){
        ...
        ->select('*','project_activity_status.post_qual as post_qual_process','project_activity_status.award_notice as award_notice_process'
        ,'project_activity_status.contract_signing as contract_signing_process','project_activity_status.proceed_notice as proceed_notice_process')
