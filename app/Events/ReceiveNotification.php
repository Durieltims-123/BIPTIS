...
use App\Contractors;
class ReceiveNotification implements ShouldBroadcastNow
{
    ...
    {
        return new Channel('receive-channel');
    }
    ...
    public function broadcastWith()
    {
        ...
        if(Auth::id() == $projectdocument->receiver_id){
            return [
                'title' => 'New Document!',
                'content' => $projectdocument->document_type.' has been sent to you for receiving from '.$projectdocument->sender_name,
